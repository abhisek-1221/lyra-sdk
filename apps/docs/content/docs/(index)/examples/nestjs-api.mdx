...
```ts title="src/comment/comment.controller.ts"
import { Controller, Get, Param, Query, Inject } from '@nestjs/common'
import { YTClient } from 'lyra-sdk'
...
```ts title="src/batch-transcript/batch-transcript.controller.ts"
...
```ts title="src/video-category/video-category.controller.ts"
import { Controller, Get, Param, Query, Inject } from '@nestjs/common'
import { YTClient } from 'lyra-sdk'
...
```ts title="src/i18n/i18n.controller.ts"
